...
const InvoicesPage = observer(() => {
  ...
  const dataArr = invoicesArr.map((invoice) => ({
    ...
    invoice_cusId: invoice.customer_id,
  ...
  const addInvoice = async () => {
    ...
    await createInvoices({
      customer_id: getCustomerId(customersArr, customerName),
      discount: discount,
      total: total,
    });
    ...
    <React.Fragment>
      ...
      <>
        ...
        <Modal show={show} onHide={handleClose}>
              ...
              >
                ...
                >
                  ...
                  {cusNamesArr.map((cusName) => (
                    <option key={cusName} value={cusName}>
                      {cusName}
                    </option>
                  ))}
                </select>
          ...
          <Modal.Footer>
            ...
            <Button variant="btn btn-dark" onClick={() => addInvoice()}>
              Add
            </Button>
          </Modal.Footer>
        </Modal>
      ...
      <Modal show={showDelInvoice}>
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              <Form.Label>
                You delete this invoice ID #: {delInvoiceId}
              </Form.Label>
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button variant="btn btn-dark" onClick={() => deleteInvoiceFn()}>
            Delete
          </Button>
        </Modal.Footer>
      </Modal>
